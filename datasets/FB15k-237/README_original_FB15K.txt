...
8. Modifications
In order to prepare the dataset for out-of-sample representation learning, we applied some minor modifications
to the FB15K-237 dataset. These modifications are as follows: Merging train, test and validation triples,
Removing some of the entities and triples, recreating train, test and validation sets (saved under processed directory).